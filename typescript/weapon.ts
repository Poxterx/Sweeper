...
class Weapon {
   ...
   private cooldown :boolean;
     ...
     */
    constructor(entity :Entity, config :WeaponConfig) {
    ...
    update() {
        ...
        this.sprite.setPosition(this.entity.getPosition().x + offset.x,
                                this.entity.getPosition().y + offset.y);
